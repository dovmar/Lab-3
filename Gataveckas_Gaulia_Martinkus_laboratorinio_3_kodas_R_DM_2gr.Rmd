...
```{r}
# Kadangi abi kovariantės nebuvo statistiškai reikšmingos pasirenkamas 
  # modelis be kovarančių
library(emmeans)

anova_test(result ~ parental_education + test_prep_course, data = x, type = 3, detailed = TRUE)
model_aov <- aov(result ~ parental_education + test_prep_course, data = x)
